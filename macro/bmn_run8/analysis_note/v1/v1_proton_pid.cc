...
void v1_proton_pid(){
  ...
  auto file_100 = std::string{"/home/mikhail/ris2/macro/bmn_run8/analysis_note/files/vf.recent.pid.2024.06.13.root"};
  ...
  auto ratio_builder = RatioBuilder<Correlation>{
    ...
    std::vector<std::string>{
      "proton_1sigma/v1.F1_RESCALED(F2_RESCALED,F3_RESCALED).y1y1centrality",
      "proton_1sigma/v1.F2_RESCALED(F1_RESCALED,F3_RESCALED).y1y1centrality",
      "proton_1sigma/v1.F3_RESCALED(F1_RESCALED,F2_RESCALED).y1y1centrality",
    }
  };
  ratio_builder
  .AddToBunch(
    ...
    file_100, 
    std::vector<std::string>{
      "proton_2sigma/v1.F1_RESCALED(F2_RESCALED,F3_RESCALED).y1y1centrality",
      "proton_2sigma/v1.F2_RESCALED(F1_RESCALED,F3_RESCALED).y1y1centrality",
      "proton_2sigma/v1.F3_RESCALED(F1_RESCALED,F2_RESCALED).y1y1centrality",
    }
  )
  .AddToBunch(
    "3#sigma"s,
    file_100, 
    std::vector<std::string>{
      "proton_3sigma/v1.F1_RESCALED(F2_RESCALED,F3_RESCALED).y1y1centrality",
      "proton_3sigma/v1.F2_RESCALED(F1_RESCALED,F3_RESCALED).y1y1centrality",
      "proton_3sigma/v1.F3_RESCALED(F1_RESCALED,F2_RESCALED).y1y1centrality",
    }
  )
  ;
  ...
  plot.Print( "/home/mikhail/ris2/macro/bmn_run8/analysis_note/v1/pictures/v1_proton_pid.png" );
}