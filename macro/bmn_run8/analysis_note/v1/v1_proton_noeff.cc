...
void v1_proton_noeff(){
  gROOT->Macro( "/home/mikhail/ris2/macro/bmn_run8/analysis_note/style.cc" );
  auto file_100 = std::string{"/home/mikhail/ris2/macro/bmn_run8/analysis_note/files/vf.recent.clean.2024.06.18.root"};
  auto file_200 = std::string{"/home/mikhail/ris2/macro/bmn_run8/analysis_note/files/vf.recent.noeff.2024.06.22.root"};
  ...
  ratio_builder.Perform([]( auto& obj ){
    obj
    .Rebin( std::vector<Qn::AxisD>{{ "centrality", 1, 10, 30 }, { "trPt", 1, 0.4, 2.0 }} )
  ...
  plot.AddSubPlot( std::vector<double>{ 0.0, 0.0, 1.0, 1.0 } )
    ...
    .SetYAxis(Axis().SetTitle("v_{1}").SetLo(-0.1).SetHi(0.55))
    .AddText( Text().SetText("BM@N RUN8").SetPosition({0.25, 0.9}).SetSize(0.04) )
    .AddText( Text().SetText("0.4<p_{T}<2.0 (GeV/c); 10-30%").SetPosition({0.25, 0.85}).SetSize(0.035) )
  ...
  plot.Print( "/home/mikhail/ris2/macro/bmn_run8/analysis_note/v1/pictures/v1_proton_noeff.png" );
}