...
void v1_proton_chi2(){
  ...
  auto file_100 = std::string{"/home/mikhail/ris2/macro/bmn_run8/analysis_note/files/vf.recent.chi2.2024.06.16.root"};
  ...
  auto ratio_builder = RatioBuilder<Correlation>{
    ...
    std::vector<std::string>{
      "proton_chi2_5/v1.F1_RESCALED(F2_RESCALED,F3_RESCALED).y1y1centrality",
      "proton_chi2_5/v1.F2_RESCALED(F1_RESCALED,F3_RESCALED).y1y1centrality",
      "proton_chi2_5/v1.F3_RESCALED(F1_RESCALED,F2_RESCALED).y1y1centrality",
    }
  };
  ratio_builder
  .AddToBunch(
    ...
    file_100, 
    std::vector<std::string>{
      "proton_chi2_4/v1.F1_RESCALED(F2_RESCALED,F3_RESCALED).y1y1centrality",
      "proton_chi2_4/v1.F2_RESCALED(F1_RESCALED,F3_RESCALED).y1y1centrality",
      "proton_chi2_4/v1.F3_RESCALED(F1_RESCALED,F2_RESCALED).y1y1centrality",
    }
  )
  .AddToBunch(
    "#chi^{2}/NDF < 3"s,
    file_100, 
    std::vector<std::string>{
      "proton_chi2_3/v1.F1_RESCALED(F2_RESCALED,F3_RESCALED).y1y1centrality",
      "proton_chi2_3/v1.F2_RESCALED(F1_RESCALED,F3_RESCALED).y1y1centrality",
      "proton_chi2_3/v1.F3_RESCALED(F1_RESCALED,F2_RESCALED).y1y1centrality",
    }
  )
  ;
  ...
  plot.Print( "/home/mikhail/ris2/macro/bmn_run8/analysis_note/v1/pictures/v1_proton_chi2.png" );
}